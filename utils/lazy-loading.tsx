...
export const LazyPages = {
  ...
  SettingsAppearance: lazy(() => import('@/app/(root)/settings/appearance/page')),
  AttendanceHistory: lazy(() => import('@/app/(root)/settings/attendance-history/page')),
...
export const LazyComponents = {
  ...
  RescheduleModal: lazy(() => import('@/components/reschedule/RescheduleModal')),
  TaskDetailDrawer: lazy(() => import('@/components/tasks/TaskDetailDrawer').then(m => ({ default: m.TaskDetailDrawer }))),
  TaskFormDrawer: lazy(() => import('@/components/tasks/TaskFormDrawer').then(m => ({ default: m.TaskFormDrawer }))),
