...
export const SubjectSchema = z.object({
  ...
  lecturer: z.array(z.string().trim().min(1, "Lecturer name cannot be empty"))
  ...
  days: z.array(z.enum(['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday']))
  ...
  category: z.enum(['lecture', 'tutorial', 'lab', 'seminar', 'other'])
    .optional()
    .default('lecture'),
  ...
  attendanceDates: z.array(z.string().datetime())
    .optional()
    .default([]),
...
export function validateSubject(data: unknown): { success: true; data: Subject } | { success: false; errors: string[] } {
  try {
