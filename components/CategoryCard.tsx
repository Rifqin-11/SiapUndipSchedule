...
const CategoryCard = ({ name, category }: subject) => {
  return (
    <div className="flex flex-col bg-pink-200 justify-around rounded-lg p-2 px-3 min-w-[260px] max-w-[260px] gap-2">
      {}
      ...
      <div className="flex max-w-60">
        <h1 className="font-black text-pink-900 text">
          {name}
        </h1>
      </div>
