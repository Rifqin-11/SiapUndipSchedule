...
export const LazyIcons = {
  ...
  History: lazy(() => import('lucide-react').then(module => ({ default: module.History }))),
  PencilIcon: lazy(() => import('lucide-react').then(module => ({ default: module.PencilIcon }))),
  UserRoundCog: lazy(() => import('lucide-react').then(module => ({ default: module.UserRoundCog }))),
  InfoIcon: lazy(() => import('lucide-react').then(module => ({ default: module.Info }))),
  ...
  Upload: lazy(() => import('lucide-react').then(module => ({ default: module.Upload }))),
...
export const LazyIcon: React.FC<LazyIconProps> = ({ name, className, size = 24 }) => {
  const IconComponent = LazyIcons[name];
  
  return (
    <Suspense fallback={<div className={`w-6 h-6 bg-gray-200 rounded ${className}`} />}>
      <IconComponent 
        className={className} 
        size={size}
      />
