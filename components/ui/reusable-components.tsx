  ...
  return (
    <CardComponent
      ...
      className={`
        ...
        ${onClick ? 'hover:shadow-md hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 cursor-pointer' : ''}
      `}
    >
      {icon && (
...
export const TouchableCard: React.FC<TouchableCardProps> = ({
  ...
  const interactiveClasses = onPress && !disabled ? `
